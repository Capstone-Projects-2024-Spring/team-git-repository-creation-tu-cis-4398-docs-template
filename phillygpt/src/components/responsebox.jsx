...
const ResponseBox = () => {
  ...
  return (
    <div className={`response-container w-1/2 h-full ${isDark ? 'bg-gray-navbar' : 'bg-white'} rounded-lg border border-gray-400 p-4 ${isDark ? 'text-white' : 'text-black'}`}>
      <div className="response-section mb-4">
        <h2 className="text-xl mb-2">Response</h2>
        <div className={`text-display ${isDark ? 'bg-darkgray' : 'bg-gray-200'} p-2 rounded-lg`}>
